...
public class StartStateFigure extends StateFigure {
   ...
   * false, true)); break; case 0: handles.add(new MoveHandle(this,
   * RelativeLocator.northWest())); handles.add(new MoveHandle(this,
   * RelativeLocator.northEast())); handles.add(new MoveHandle(this,
   * RelativeLocator.southWest())); handles.add(new MoveHandle(this,
   * RelativeLocator.southEast()));
   * 
   * ConnectorHandle ch; handles.add(ch = new ConnectorHandle(new
   * LocatorConnector(this, RelativeLocator.center()), new TransitionFigure()));
   * ch.setToolTipText("Drag the connector to a dependent state."); break; }
   * return handles; }
   */
}